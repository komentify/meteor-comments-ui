(function () {
  ...
  Template.commentsBox.helpers({
    ...
    isEditable: function () {
      return Comments.session.equals('editingDocument', this._id);
    }
  });
  ...
  Template.commentsBox.events({
    ...
    'click .edit-action' : function (e) {
      ...
      $(e.target).closest('.comment').find('.comment-content').attr('contenteditable', true);
      Comments.session.set('editingDocument', this._id);
    },
    'click .save-action' : function (e) {
      var contentBox = $(e.target).closest('.comment').find('.comment-content'),
      ...
      if (this.content !== newContent) {
        Comments.edit(this._id, newContent);
      }
    },
