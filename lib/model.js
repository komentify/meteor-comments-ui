Comments = (function () {
  ...
  // TODO: data is not always found, login as Awesome Guy with testtest to reproduce
      ...
      return {
        ...
        children: [{
          find: function (comment) {
            return Meteor.users.find({ _id: comment.userId }, { limit: 1, fields: { profile: 1, emails: 1, username: 1 } });
          }
        }]
      };
    })
