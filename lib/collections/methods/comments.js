...
Meteor.methods({
  'comments/add': function (referenceId, content, captchaData, anonUserData) {
    check(referenceId, String)
    check(content, String)
    check(captchaData, Match.OneOf(Object, undefined))
    ...
    if (anonUserData._id && Meteor.isServer) {
      validateCaptchaIfRequired(referenceId, config, captchaData)
    }
  ...
  'comments/reply/add': function (documentId, docScope, content, captchaData, anonUserData) {
    check(documentId, String)
