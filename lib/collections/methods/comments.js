...
Meteor.methods({
  ...
  'comments/reply/remove': function (documentId, replyId, anonUserData) {
    ...
    doc.replies = removeReplyByReplyId(doc.replies, replyId, reply => reply.userId === userId)
...
CommentsCollection.methods = {
  ...
  likeReply: (documentId, replyId) => callWithAnonUserData('comments/reply/like', documentId, replyId),
  dislike: (documentId) => callWithAnonUserData('comments/dislike', documentId),
  dislikeReply: (documentId, replyId) => callWithAnonUserData('comments/reply/dislike', documentId, replyId),
  star: (documentId, starsCount) => callWithAnonUserData('comments/star', documentId, starsCount),
  starReply: (documentId, replyId, starsCount) => callWithAnonUserData('comments/reply/star', documentId, replyId, starsCount),
  edit: (documentId, newContent) => callWithAnonUserData('comments/edit', documentId, newContent),
  editReply: (documentId, replyId, content) => callWithAnonUserData('comments/reply/edit', documentId, replyId, content),
