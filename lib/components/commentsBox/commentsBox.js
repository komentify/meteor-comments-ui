  ...
  'click .like-action' : function (event) {
    ...
    executeUserAction(event, 'like comments', function () {
      if (eventScope._id) {
        ...
        Comments.likeReply(eventScope.documentId, eventScope.replyId)
      }
    })
  },
  'click .dislike-action': function (event) {
    ...
    executeUserAction(event, 'dislike comments', function () {
      if (eventScope._id) {
        ...
        Comments.dislikeReply(eventScope.documentId, eventScope.replyId)
      }
    })
  },
  'click .stars-action': function (event) {
    ...
    executeUserAction(event, 'rate comments', function () {
      ...
      if (eventScope._id) {
        ...
        Comments.starReply(eventScope.documentId, eventScope.replyId, starRating)
      }
    })
  },
